...
def LoadHippocampusData(root_dir, y_shape, z_shape):
    ...
    for f in images:
        ...
        # <YOUR CODE GOES HERE>
        #Normalize dividing the image by its maximum value
        ...
        #skip the images with image_shape has y or z shape greater than 64
        if (y_shape<image.shape[1] or z_shape<image.shape[2] ):
            print("Skipping filename:",f,"shape:",image.shape[0],image.shape[1],image.shape[2])
            continue
